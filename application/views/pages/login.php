                  ...
                  <div class="slider_area">
                    ...
                    <div class="slick_slider">
                      <div class="single_iteam">
                        <a href="single_page.html"> <img src="<?php echo base_url()?>assets/img/works_slider1.jpg" alt="img"></a>                          
                      </div>
                      <div class="single_iteam">
                        <a href="single_page.html"> <img src="<?php echo base_url()?>assets/img/works_slider2.jpg" alt="img"></a>                          
                      </div>
                      <div class="single_iteam">
                        <a href="single_page.html"> <img src="<?php echo base_url()?>assets/img/works_slider1.jpg" alt="img"></a>                          
                      </div>
          ...
          <div class="team_area wow fadeInLeftBig">
            ...
            <div class="team">
              <ul class="team_nav">
                <li>
                  <div class="team_img">
                    <img src="<?php echo base_url()?>assets/img/leify.png" alt="team-img">
                  </div>
              ...
              <li>
               <div class="testimonial_content">
                  ...
                  <div class="client_img">
                    <img src="<?php echo base_url()?>assets/img/leify.png" alt="img">
                  </div>
               </div>
              </li>
             <li>
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="single_featured_blog">                      
                    <img alt="img" src="<?php echo base_url()?>assets/img/blog.jpg">
          ...
          <div class="clients_brand_area wow flipInX">
            ...
            <div class="clients_brand">
             ...
             <ul class="clb_nav wow flipInX">
               <li><img src="<?php echo base_url()?>assets/img/envato-studio.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/codecanyon.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/audiojungle.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/themeforest.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/envato-studio.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/codecanyon.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/audiojungle.png" alt="brand-img"></li>
               <li><img src="<?php echo base_url()?>assets/img/themeforest.png" alt="brand-img"></li>
